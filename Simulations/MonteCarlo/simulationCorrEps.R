...
save(varY,file="varYCorrEps.Rda")
save(coeffs,file="coeffsCorrEps.Rda")
save(RMSEs,file="RMSEsCorrEps.Rda")
save(devs,file="devsCorrEps.Rda")
save(Ns,file="NsCorrEps.Rda")
save(fits,file="fitsCorrEps.Rda")
}
