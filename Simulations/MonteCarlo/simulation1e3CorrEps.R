...
save(varY,file="varY1e3CorrEps.Rda")
save(vareta,file="vareta1e3CorrEps.Rda")
save(coeffs,file="coeffs1e3CorrEps.Rda")
save(RMSEs,file="RMSEs1e3CorrEps.Rda")
save(devs,file="devs1e3CorrEps.Rda")
save(Ns,file="Ns1e3CorrEps.Rda")
save(fits,file="fits1e3CorrEps.Rda")
}
