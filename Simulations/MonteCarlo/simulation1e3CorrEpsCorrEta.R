...
save(varY,file="varY1e3CorrEpsCorrEta.Rda")
save(vareta,file="vareta1e3CorrEpsCorrEta.Rda")
save(coeffs,file="coeffs1e3CorrEpsCorrEta.Rda")
save(RMSEs,file="RMSEs1e3CorrEpsCorrEta.Rda")
save(devs,file="devs1e3CorrEpsCorrEta.Rda")
save(Ns,file="Ns1e3CorrEpsCorrEta.Rda")
save(fits,file="fits1e3CorrEpsCorrEta.Rda")
}
